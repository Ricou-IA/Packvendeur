  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <PageMeta
        ...
        description="Le vendeur peut faire le pre-etat date lui-même (confirmé par le CSN). Comparez les 3 options : syndic (150-600 EUR), DIY (gratuit), IA (24,99 EUR, 5 min)."
      ...
      <article>
        ...
        <div className="bg-primary-50 border border-primary-200 rounded-xl p-6 mb-8">
          ...
          <dl className="space-y-2 text-sm text-secondary-700">
            ...
            <div className="flex gap-2">
              ...
              <dd>L'état daté (syndic obligatoire, 380 EUR max) est un document different</dd>
            </div>
            <div className="flex gap-2">
        ...
        <p className="text-secondary-600 leading-relaxed mb-4">
          ...
          est censé fournir le pre-etat date ? Le vendeur, le syndic, le notaire ? La reponse
        ...
        <div className="flex items-start gap-3 bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
          ...
          <p className="text-sm text-secondary-700">
            ...
            vendeur doit fournir a l'acquéreur, des la promesse de vente, un ensemble d'informations
            relatives à l'organisation de la copropriété, a la situation financière du copropriétaire
            vendeur et de la copropriété, et a l'etat du bâtiment.
          </p>
        </div>
        <p className="text-secondary-600 leading-relaxed mb-4">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4">
          <div className="space-y-2">
            <div className="flex items-start gap-2 text-secondary-600 text-sm">
              ...
              <span>Le syndic a accès a toutes les données comptables</span>
            </div>
            <div className="flex items-start gap-2 text-secondary-600 text-sm">
              <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
        ...
        <p className="text-secondary-600 leading-relaxed mb-4">
          ...
          a l'état daté (plafonné à 380 EUR), le prix du pre-etat date n'est pas réglementé.
          Les syndics profitent souvent de cette absence de plafond pour facturer des tarifs
          élevés. Consultez notre article sur
          le <Link to="/guide/cout-pre-etat-date-syndic" className="text-primary-600 hover:text-primary-800 font-medium">coût du pre-etat date chez le syndic</Link> pour
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-4">
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-2 text-secondary-600 text-sm">
              <X className="h-4 w-4 text-red-500 flex-shrink-0 mt-0.5" />
              <span>Complexe : 60+ données financières a extraire</span>
            </div>
            <div className="flex items-start gap-2 text-secondary-600 text-sm">
              <X className="h-4 w-4 text-red-500 flex-shrink-0 mt-0.5" />
        ...
        <p className="text-secondary-600 leading-relaxed mb-4">
          ...
          minutes. C'est le meilleur équilibre entre cout, rapidité et fiabilité.
        </p>
        ...
        <p className="text-secondary-600 leading-relaxed mb-4">
          C'est une confusion fréquente. Le <strong>pre-etat date</strong> et
        ...
        <ul className="space-y-2 text-secondary-600 leading-relaxed ml-6 list-disc mb-4">
          ...
          <li>
            L'<strong>etat date</strong> est établi obligatoirement par le syndic au moment de la
        ...
        <div className="space-y-6 mb-8">
          <div>
            <h3 className="text-lg font-semibold text-secondary-800 mb-2">
              Le vendeur peut-il faire le pre-etat date lui-même ?
            </h3>
            <p className="text-secondary-600 leading-relaxed">
              Oui. Le CSN a confirmé que le vendeur peut établir le pre-etat date sans recourir
          ...
          <div>
            ...
            <p className="text-secondary-600 leading-relaxed">
              Le pre-etat date est fourni au compromis, le vendeur peut le faire lui-même.
              L'état daté est fourni a l'acte authentique et doit être établi par le syndic
              (plafonné à 380 EUR). Les deux couvrent des informations similaires mais a des
        ...
        <section className="text-center bg-secondary-50 rounded-2xl p-8 mt-12">
          <h2 className="text-2xl font-semibold text-secondary-900 mb-3">
            Faites votre pre-etat date vous-même, avec l'aide de l'IA
          </h2>
